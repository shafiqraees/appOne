...
<body>
    ...
    <div class="jumbotron text-center">
        ...
        <h1>Success Page</h1>
        <p>This is an example of a Success Page</p>

    </div>

    <div class="container" >
    
      <p>The buyer arrives at this page on your website once a payment has been completed on PayFast.
      </p>
      <p>
      This has been defined by the return_url on the checkout page.
      </p>
      <p>      
  	  Example text: <strong>Thank you for making the payment. Your order will be shipped to you shortly.</strong>
      </p>
